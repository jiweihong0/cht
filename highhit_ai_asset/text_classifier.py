...
class TextClassifier:
    def __init__(self, csv_path='AI_data.csv'):
        """
        初始化文本分類器
        Args:
            csv_path: CSV 資料檔案路徑
        ...
        self.categories = ['有形資產', '無形資產']  # 根據 AI_data.csv 的資產類別調整
...
def classify_single_text(text, csv_path='AI_data.csv', method='average'):
    """
    便利函數：對單一文本進行分類
    Args:
        text: 輸入文本
